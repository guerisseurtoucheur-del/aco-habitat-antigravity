        ...
        <div className="container">
          <div className={styles.trustStripInner}>
            <span className={styles.trustStripItem}>
              ...
              ACO-HABITAT · Marque déposée à l&apos;INPI
            </span>
            <span className={styles.trustStripItem}>
              <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M20 6 9 17l-5-5"></path></svg>
              Méthode protégée (dépôt e-Soleau)
            </span>
            <span className={styles.trustStripItem}>
              <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"></path></svg>
              Spécialiste du bois depuis 2006
            </span>
          </div>
        </div>
      </div>
      ...
      <section className={styles.savoirSection}>
        <div className="container">
          ...
          <div className={styles.savoirGrid}>
            {[
              { src: '/realisations/traitement-maitresse-poutre.png', alt: 'Technicien ACO-HABITAT traitant une maîtresse-poutre en chêne au pinceau' },
              { src: '/realisations/comble-charpente-ancienne.jpeg', alt: 'Charpente de comble ancienne en cours de restauration' },
              { src: '/realisations/plafond-solives-restaure.jpeg', alt: 'Plafond à solives en chêne restaurées' },
              { src: '/realisations/traitement-plafond-solives.jpeg', alt: 'Traitement d’un plafond à solives sur mur en pierre' },
            ].map((img) => (
              <div key={img.src} className={styles.savoirCard}>
